    ...
    return (
        <>
            <div class="container-fluid bg-1 text-center" id="about">
                ...
                <img src={require("../assets/icon-picture.png")} class="img-responsive img-circle margin" alt="profile icon" width="250" height="250"/>
            ...
            <div class="container-fluid bg-2 text-center" id="who">
                ...
                <img src={require("../assets/longhorns_logo.jpg")} class="img-responsive margin"  alt="longhorn" width="200"/>
            </div>
        </>
    );
}
